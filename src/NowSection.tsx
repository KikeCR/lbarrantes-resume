...
const content = {
	en: {
		...
		body: 'Exploring how AI agents and LLM tooling reshape day-to-day engineering by building with them, not just talking about them.',
	},
	es: {
		sectionTitle: 'En qué estoy enfocado ahora',
		body: 'Explorando cómo los agentes de IA y las herramientas basadas en LLMs están cambiando el trabajo diario de ingeniería, construyendo con ellas y no solo hablando de ellas.',
	},
}
